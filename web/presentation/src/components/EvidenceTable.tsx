...
const labs: LabRow[] = [
  { num: 1, lab: 'POSCO International', country: 'South Korea', flag: '\u{1F1F0}\u{1F1F7}', tested: 'Production-representative lump ore', proved: '67.31% Fe with very low impurities — shipping-grade premium', detail: 'Year: 2019. Sample: stockpile lump ore. Method: standard steelmaker feedstock analysis. P: 0.012-0.021%, S: 0.002-0.013%.' },
  ...
  { num: 7, lab: 'CCIC Philippines', country: 'Philippines', flag: '\u{1F1F5}\u{1F1ED}', tested: 'Iron ore and copper from drill holes', proved: '59.34% Fe iron ore, 6.33% Cu from MEGA DH-4. High sulfur confirms sulfide mineralization.', detail: 'March 2025. International testing house. 4 copper samples from drill hole series. Sulfur 2.95-8.19% — porphyry indicator.' },
